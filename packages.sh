...
if ask "install useful commandline tools?" N; then
	apt-get install -y terminator bpython zsh build-essential cmake python-dev git curl vim tree openvpn gnupg2 # cifs-utils binutils-mingw-w64 gcc-mingw-w64 mingw-w64 mingw-w64-dev
fi
